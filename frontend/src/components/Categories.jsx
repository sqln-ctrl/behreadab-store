    ...
    <section ref={ref} className="bg-black py-20 px-5 md:px-8">
      <div className="max-w-7xl mx-auto">
        <motion.div className="text-center mb-14"
          ...
          <h2 className="text-4xl font-black text-white" style={{ fontFamily: "'Georgia', serif" }}>Shop By Category</h2>
        </motion.div>
          ...
          {categories.map((cat, i) => (
            <motion.div key={cat.id}
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-end pb-10 px-8 text-center">
                ...
                <h3 className="text-white text-3xl font-black" style={{ fontFamily: "'Georgia', serif" }}>{cat.name}</h3>
