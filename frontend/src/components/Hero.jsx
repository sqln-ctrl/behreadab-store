...
const Hero = () => {
  const textVariants = {
    ...
    visible: (i) => ({ opacity: 1, y: 0, transition: { duration: 0.7, delay: i * 0.16, ease: [0.22, 1, 0.36, 1] } }),
  };
        ...
        <div className="relative w-full max-w-7xl mx-auto px-5 md:px-8 py-20 md:py-28 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16">
          ...
          <div className="w-full md:max-w-xl z-10 text-center md:text-left">
            ...
            <motion.div custom={0} variants={textVariants} initial="hidden" animate="visible"
              ...
              <img src="/logo.jpg" alt="Andaaz" className="h-14 w-14 rounded-full object-cover" style={{ filter: "invert(1)" }} />
            ...
            <motion.p custom={4} variants={textVariants} initial="hidden" animate="visible"
              ...
              Premium watches crafted for those who understand that time is not just measured — it is worn.
            </motion.p>
          ...
          <motion.div
            ...
            <motion.div
              ...
              <p className="font-black text-lg">PKR 48,000</p>
            </motion.div>
          </motion.div>
        </div>
